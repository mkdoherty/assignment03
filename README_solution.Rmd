...
```{r distributions, dev=c("png", "pdf"), fig.align='center', fig.path="./figures/"}
...
The distribution of colors I observed was not significantly different from what you'd expect if they were evenly distributed (P=`r round(skittle.test$p.value, 2)`)
